            ...
            <div className='grid w-full h-screen gap-16 grid-cols-2 items-center container mx-auto'>
                <div className=' text-white space-y-3'>
                    ...
                    <div className=' flex items-center space-x-3 pt-8'>
                        <button className=' btn px-8 bg-yellow-300 border-none text-lg '>ORDER NOW</button>
                ...
                <div className=' relative'>
                    ...
                    <img className='absolute -bottom-10 right-0 max-w-44' src="https://dev.foodotawp.com/wp-content/uploads/2021/08/layer-1206-1.png" />
                    <img className='absolute -top-0 right-10 w-[80px]' src="https://dev.foodotawp.com/wp-content/uploads/2021/08/layer-1207-1.png" />
