...
import { ClientCommentsarray } from "../../Utils/ClientsComment";

const ClientSection = () => {


    const [currentSlider, setCurrentSlider] = useState(0);
    const prevSlider = () => setCurrentSlider((currentSlider) => (currentSlider === 0 ? ClientCommentsarray.length - 2 : currentSlider - 1));
    const nextSlider = () => setCurrentSlider((currentSlider) => (currentSlider === ClientCommentsarray.length - 2 ? 0 : currentSlider + 1));
    useEffect(() => {
            ...
            <div className="max-w-[70%] min-w-[350px] mx-auto h-[400px] flex flex-row items-center overflow-hidden gap-5 lg:gap-10 px-8 md:px-16 lg:px-24">
                <div className="relative overflow-hidden">
                    ...
                    <div
                        ...
                        {/* sliders */}
                        {ClientCommentsarray?.map((each, idx) => (
