            ...
            <div className="navbar ">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-yellow-600 lg:bg-base-100 rounded-box w-52 ">
                            {navLinks}
                        </ul>
                    </div>
                ...
                <div className="navbar-end">
                    <div className='text-white mr-5 flex items-center space-x-3 border-r pr-4'>
                        <Link to={'/del_rec'}><FaTruck className=' text-2xl md:text-4xl' /></Link>
                    ...
                    {
                        user?.email && <div className=' relative hidden md:block'>
